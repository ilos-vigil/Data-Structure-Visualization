...
class Bst {
    ...
    insert(data, head,kali,bagi,tinggi) {
        if (head === null) {
            ...
            ctr++;
            this.root = new Node(data,"node"+ctr);
            ...
            if (head.left === null) {
                ctr++;
                head.left = new Node(data,"node"+ctr);
            ...
            if (head.right === null) {
                ctr++;
                head.right = new Node(data,"node"+ctr);
                createLine(484/bagi *kali+1,tinggi,(484/(bagi*2) )*((kali*2)+1),tinggi+50,ctrLines); 
                drawString((484/(bagi*2))*((kali*2)+1),tinggi+50,tinggi+50,data+ "") ;
                createCircle(tinggi+50,(484/(bagi*2))*((kali*2)+1),ctr );
